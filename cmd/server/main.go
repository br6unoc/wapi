...
func main() {
	...
	// Envio e pairing passkey — usa API Key
	...
	r.POST("/instances/:name/passkey/response", handler.APIKeyMiddleware(), handler.PasskeyResponse)
	r.POST("/instances/:name/passkey/confirm", handler.APIKeyMiddleware(), handler.PasskeyConfirm)
